function Cnumber = RBF_FD_PHS_pol_condnum (xyz,m,d)
...
%  
% Output parameter 
%     Cnumber     Condition number for the RBF-FD matrix solving for weights
%           for d/dx, d/dy, d/dz and for d2/{dx2,dxy,dy2,dxz,dyz,dz2}.
x = xyz(:,1);
y = xyz(:,2);
z = xyz(:,3);
