...
\begin{figure}
	...
	\caption{Middle East and Europe, represented by 201 694 nodes after 10 repelling iterations; K=20. Altitudes are exaggerated by a factor of 100.}
	\label{europe}
\end{figure}
...
\begin{figure}[h!]
	...
	\includegraphics[width=\linewidth]{greece.png}
		%        \caption{bb}
	\end{subfigure}
	\caption{Left,  Right, a fragment of Greece.} 
	\label{fig:mult}
\end{figure}
